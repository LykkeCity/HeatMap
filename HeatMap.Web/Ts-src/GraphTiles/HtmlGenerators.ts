...
namespace Lykke.GraphTiles {
    ...
    export class HtmlGenerators {
        ...
        public static generateAssetChart(ad: IAssetData, asset: IAssetPair, width: number, height: number): string {
            ...
            let maxDeviation = Utils.pips(min, max, asset.accuracy);
            ...
            let y = height - Utils.pips(min, ad.history[0], asset.accuracy) / yZoom;
            ...
            for (let i = 1; i < ad.history.length; i++) {
                ...
                y = height - Utils.pips(min, ad.history[i], asset.accuracy) / yZoom;
